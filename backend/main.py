...
from views import company_view, investor_relations_view, user_view, graph_view, investment_view, performance_view, capital_view, investor_view, roi_view, chat_view
