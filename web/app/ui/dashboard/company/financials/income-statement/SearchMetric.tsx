...
import { incomeStatementMetrics } from "./data";
...
const SearchMetric = ({ paginationQuery }: searchProps) => {
  ...
  const [finalMetrics, setFinalMetrics] = useState(incomeStatementMetrics);
  ...
  useEffect(() => {
    const filteredMetrics = incomeStatementMetrics.filter((m) =>
