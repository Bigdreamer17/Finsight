...
const ErrorFallback = ({
  ...
  const description =
    "An error occurred while getting company overview details. Please try again.";
  ...
  return (
    <div className="px-4 pb-4 h-full mt-2.5">
      <div className="h-full w-full bg-[#2C2C35] grid place-items-center">
