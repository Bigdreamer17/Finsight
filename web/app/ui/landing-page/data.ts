export const features = [
  ...
  },
  {
    ...
    description:
      "From the most sophisticated to serious individual investors, FinSight is providing the most powerful fundamental research platform for every use case.",
  },
  {
    name: "Highest quality data",
    description:
